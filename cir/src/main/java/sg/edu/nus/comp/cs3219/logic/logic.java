...
public class logic {
	...
	public Vector<String> getNumReferencePaper(String conference, Vector<String> referencingConference) {
		Vector<String> result = new Vector<String>();
	...
	//Answer Format: <year> <integer>
	public Vector<String> getNumReferencePaperByAuthor(Vector<String> conference,String author, int from, int to) {
		Vector<String> result = new Vector<String>();
		for (int i = from; i <= to; i++) {
	...
	//Answer Format: <conference> <integer>
	public Vector<String> getNumReferencePaper(Vector<String> conference, String referencingConference) {
		Vector<String> result = new Vector<String>();
		for (String s : conference) {
